...
<?= $this->section('title') ?>Tambah Box Surat Penyerahan | ArsipKu<?= $this->endSection() ?>

<?= $this->section('content') ?>
<section class="content-header">
    <div class="container-fluid">
        <h1>Tambah Box Surat Penyerahan</h1>
    </div>
</section>
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?= site_url('admin/surat-penyerahan-boxes') ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="<?= site_url('admin/surat-penyerahan-boxes') ?>" class="btn btn-secondary">Kembali</a>
